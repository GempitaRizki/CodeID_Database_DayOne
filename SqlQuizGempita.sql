...
create table project_assignment (
	pras_proj_id integer primary key,
...
ALTER TABLE project_assignment ADD CONSTRAINT pras_proj_id_pkey PRIMARY KEY (pras_proj_id);
ALTER TABLE project_assignment ADD PRIMARY KEY (pras_proj_id);
ALTER TABLE project_assignment ADD PRIMARY KEY (pras_proj_id, pras_employee_id);
...
ADD CONSTRAINT proj_account_mgr_fkey FOREIGN KEY (proj_account_mgr) REFERENCES employees(proj_account_mgr);

ALTER TABLE projects 
ADD CONSTRAINT proj_account_mgr_fkeys FOREIGN KEY (proj_account_mgr) REFERENCES employees(manager_id);

//soal nomor 4
SELECT * FROM employees
SELECT * FROM projects
ALTER TABLE projects 
ADD COLUMN proj_customer varchar(100);
...
ADD CONSTRAINT pras_proj_id_fk FOREIGN KEY (pras_proj_id) REFERENCES projects(proj_id),
ADD CONSTRAINT pras_employee_id_fk FOREIGN KEY (pras_employee_id) REFERENCES employees(employee_id)
;
